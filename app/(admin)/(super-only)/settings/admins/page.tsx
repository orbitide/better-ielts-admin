import { getAdmins, getAuditLog } from '@/lib/data/admins'
...
export default async function AdminsPage() {
  const [admins, auditLog] = await Promise.all([getAdmins(), getAuditLog()])
  ...
  return (
    <div className="p-5 sm:p-6 space-y-6 max-w-4xl mx-auto">
      ...
      />
      <AdminsManagementShell initialAdmins={admins} initialLog={auditLog} />
    </div>
  )
}
